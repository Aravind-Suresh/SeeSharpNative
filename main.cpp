...
int main(int argc, char* argv[])
{
    ...
    Ptr<ERFilter> er_filter1 = createERFilterNM1(loadClassifierNM1("/home/ubuntu/opencv/opencv-3.0.0/modules/opencv_contrib/modules/text/samples/trained_classifierNM1.xml"),8,0.00015f,0.13f,0.2f,true,0.1f);
    Ptr<ERFilter> er_filter2 = createERFilterNM2(loadClassifierNM2("/home/ubuntu/opencv/opencv-3.0.0/modules/opencv_contrib/modules/text/samples/trained_classifierNM2.xml"),0.5);
    ...
    imwrite(string(argv[4]), out_img);
    imwrite(string(argv[3]), out_img_segmentation);
    imwrite(string(argv[2]), out_img_decomposition);
